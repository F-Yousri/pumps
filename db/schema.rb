...
ActiveRecord::Schema.define(version: 2019_01_22_220606) do
  ...
  create_table "additional_criteria", force: :cascade do |t|
    t.string "name"
    t.float "value"
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
  ...
  create_table "economic_weights", force: :cascade do |t|
    t.string "factor"
    t.integer "weight"
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
  ...
  create_table "pcp_conditions", force: :cascade do |t|
    ...
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
    t.float "viscosity_from"
    t.float "viscosity_to"
  end
